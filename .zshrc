...
plugins=(git battery aws azure zsh-bat zoxide eza fzf kubectx python terraform brew zsh-autosuggestions zsh-syntax-highlighting kubectl Kube-ps1)
...
source ~/Documents/AzClI/az.completion
